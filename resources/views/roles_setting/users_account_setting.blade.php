...
<div class="row">
    ...
    <div class="col-sm-4 mb-4 mb-xl-0">
      <div class="widgetbar text-right">
        <button type="button" class="btn btn-info font-weight-bold" data-animation="slideInRight" data-toggle="modal" data-target="#addusers"><i class="icon-speech-bubble"></i>                                        
              ...
              <tbody>
                ...
                <tr id="{{$val->id}}">
                  ...
                  <td><div class="btn-group btn-group-sm" style="float: none;">
                        ...
                        <button type="button" class="btn btn-danger" style="float: none; margin: 5px;"><a onclick="deleteuser('{{$val->id}}')"><span class="fa fa-trash"></span></a></button>
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            ...
                                            <div class="form-group mb-10">
                                              ...
                                              <input type="text" class="form-control bg_input" minlength="5" placeholder="Enter your username" id="username" name="username" value="{{$val->username}}" required="" title="minimum 5 characters needed" readonly="">
                                            </div>
                                            <div class="form-group mb-10">
                                              <label for="stage_color"> Email: </label>
                                              <input type="email" class="form-control bg_input" value="{{$val->email}}" placeholder="Enter your email" name="email" id="add_email"  readonly="">
                                            </div>
                                            <div class="form-group mb-10">
                                      ...
                                      <div class="modal-dialog  slideInRight  animated" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <div class="form-group mb-10">
                                              <label for="stage_name">Full Name: </label>
                                              <input type="text" class="form-control bg_input" placeholder="Enter your name"  name="full_name"  required="">
                                            </div>
                                            <div class="form-group mb-10">
                                              <label for="username"> Username: </label>
                                              <input type="text" class="form-control bg_input" minlength="5" placeholder="Enter your username"  name="username"  required="" title="minimum 5 characters needed" >
                                            </div>
                                            <div class="form-group mb-10">
                                              <label for="stage_color"> Email: </label>
                                              <input type="email" class="form-control bg_input"  placeholder="Enter your email" name="email" id="add_email"  >
                                            </div>
                                            <div class="form-group mb-10">
                                              <label for="stage_name"> Contact: </label>
                                              <input type="text" maxlength="10" pattern="[6-9]{1}[0-9]{9}" title="Phone number with 6-9 and remaing 9 digit with 0-9" class="form-control"  placeholder="Enter your contact" name="contact"  required="">
                                            </div>
                                            <div class="form-group mb-10">
                                              <label for="stage_name"> Password: </label>
                                              <input type="text" class="form-control bg_input" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" placeholder="Enter your Password" name="password" required="">
                                            ...
                                            <div class="form-group mb-10">
                                              <label for="stage_name"> Date Of Birth: </label>
                                              <input type="text" data-date-format="YYYY MMMM DD"  class="form-control"  placeholder="Enter your date of birth" name="dob" id="add_dob">
                                            </div>
                                            <div class="form-group mb-10">
                                              <label for="stage_name"> Role: </label>
