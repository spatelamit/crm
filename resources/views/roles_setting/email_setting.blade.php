...
<<<<<<< HEAD
    <div class="col-sm-4 mb-4 mb-xl-0">
      <div class="widgetbar text-right">
        <button type="button" class="btn btn-info font-weight-bold" data-animation="slideInRight" data-toggle="modal" data-target="#addemail"><i class="icon-speech-bubble"></i>                                        
Add Email template </button>
      </div>
    </div>
  </div>
=======
>>>>>>> fa86f5e4123b89c2fad39b67c278cb58ad5dcbf9
