...
<body>
    ...
    <div class="app app-fh">
        ...
        <div class="app-container"
            style="background: url(https://srtscrm.theofficearea.in/assets/assets/images/background/bg-11.jpg) center center no-repeat fixed">
            <div class="app-login-box">
                <div class="app-login-box-user"><img
                        src="https://srtscrm.theofficearea.in/assets/assets/images/background/no-image.png"></div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <button type="submit" name="submit" class="btn btn-success btn-block">Sign
                                        In</button>

                                    <p data-track-content="" data-content-name="LognForm"
                                        data-content-piece="forget_password" data-content-target="forget_password"
                                        style="text-align: center; margin-top:10px;"><a href="#"
                                            style="color:#000;">Forget Password</a></p>
                                </div>
                            </div>
                        </div>
                    </form>
