...
<link href="https://themesbox.in/admin-templates/soyuz/html/light-vertical/assets/plugins/dragula/dragula.min.css"
    rel="stylesheet">
<script src="https://themesbox.in/admin-templates/soyuz/html/light-vertical/assets/plugins/dragula/dragula.min.js">
</script>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"> <span
                                                                    class="icon-briefcase text-warning"></span>Add
                                                                meeting </a>
                                                            <a class="dropdown-item"><span
                                                                    class="icon-briefcase"></span>Make a Deal </a>
                                                            <a class="dropdown-item"><span
                                                                    class="icon-pushpin text-danger"></span>Add task
                                                            </a>
                                                            <a class="dropdown-item"><span
                                                                    class="icon-trash text-info"></span> Delete</a>
                                                            <a class="dropdown-item"><span
                                                                    class="icon-spell-check text-warning"></span> Notes
                                                            </a>
                                                            <a class="dropdown-item"><span
                                                                    class="icon-clock text-danger"
                                                                    aria-hidden="true"></span> Edit Detail </a>
                                                            <a class="dropdown-item"><span
                                                                    class="icon-smartphone text-info"></span> Send Email
                                                            </a>
                                                            <a class="dropdown-item"><span
...
>>>>>>> c7fec02d8e7c45498ff315ac7cde0d1db95bb615
                                        ...
                                        <div class="col-4">
                                            <div class="kanban-menu">
                                                <div class="dropdown">
                                                    <button
                                                        class="btn btn-link text-success p-0 m-0 border-0 l-h-20 font-16"
...
>>>>>>> c7fec02d8e7c45498ff315ac7cde0d1db95bb615
                                        ...
                                        <div class="col-4">
                                            <div class="kanban-menu">
                                                <div class="dropdown">
                                                    <button
                                                        class="btn btn-link text-warning p-0 m-0 border-0 l-h-20 font-16"
...
>>>>>>> c7fec02d8e7c45498ff315ac7cde0d1db95bb615
                                        ...
                                        <div class="col-4">
                                            <div class="kanban-menu">
                                                <div class="dropdown">
                                                    <button
                                                        class="btn btn-link text-secondary p-0 m-0 border-0 l-h-20 font-16"
                        ...
                        <button type="button" class="btn btn-secondary-rgba btn-block btn-lg font-16"><i
                                class="feather icon-plus mr-2"></i>Add Project</button>
                    </div>
                </div>
            </div>
            <!-- End col -->
...
<script src="https://themesbox.in/admin-templates/soyuz/html/light-vertical/assets/js/custom/custom-crm-lead.js">
</script>
